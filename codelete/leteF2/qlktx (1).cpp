...
protected:
    ...
    int age;
    string address;
    string id; //mĂƒÆ’Ă‚Â£ sinh viĂƒÆ’Ă‚Âªn
    double money;
    bool check;
...
{
private:
    string identitycard; //sĂƒÂ¡Ă‚Â»Ă¢â‚¬Ëœ CMND
    int room;            // sĂƒÂ¡Ă‚Â»Ă¢â‚¬Ëœ phĂƒÆ’Ă‚Â²ng ĂƒÂ¡Ă‚Â»Ă…Â¸
    double unitprice;    //dĂƒâ€ Ă‚Â¡n gia
    int violations;      //sĂƒÂ¡Ă‚Â»Ă¢â‚¬Ëœ lĂƒÂ¡Ă‚ÂºĂ‚Â§n vi phĂƒÂ¡Ă‚ÂºĂ‚Â¡m
    double months;       //sĂƒÂ¡Ă‚Â»Ă¢â‚¬Ëœ thĂƒÆ’Ă‚Â¡ng ĂƒÂ¡Ă‚Â»Ă…Â¸
public:
    Student();
    ~Student();
...
{
private:
    double coefficientssalary; //TiĂƒÂ¡Ă‚Â»Ă‚Ân lĂƒâ€ Ă‚Â°Ăƒâ€ Ă‚Â¡ng
    string position;           //ChĂƒÂ¡Ă‚Â»Ă‚Â©c vĂƒÂ¡Ă‚Â»Ă‚Â¥
    string phone;              //CMND
    double seniority;          //thĂƒÆ’Ă‚Â¢m niĂƒÆ’Ă‚Âªn
public:
    Manage();
    ~Manage();
...
void Dormitory::sapxepName()
{
    for (int i = 0; i < list_person.size() - 1; i++)
    {
        ...
        {
            //TĂƒÂ¡Ă‚ÂºĂ‚Â¡o biĂƒÂ¡Ă‚ÂºĂ‚Â¿n lĂƒâ€ Ă‚Â°u tĂƒÆ’Ă‚Âªn dĂƒâ€ Ă‚Â°ĂƒÂ¡Ă‚Â»Ă¢â‚¬Âºi dĂƒÂ¡Ă‚ÂºĂ‚Â¡ng mĂƒÂ¡Ă‚ÂºĂ‚Â£ng kĂƒÆ’Ă‚Â­ tĂƒÂ¡Ă‚Â»Ă‚Â±
            ...
            //SĂƒÂ¡Ă‚ÂºĂ‚Â¯p xĂƒÂ¡Ă‚ÂºĂ‚Â¿p tĂƒÆ’Ă‚Âªn theo mĂƒÂ¡Ă‚ÂºĂ‚Â£ng kĂƒÆ’Ă‚Â­ tĂƒÂ¡Ă‚Â»Ă‚Â±
