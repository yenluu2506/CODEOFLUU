...
void Book::in(){
	...
	SET_COLOR(5);
	cout << setw(8) << sid << setw(25) << stitle << setw(30) << sAuthor << setw(30) << nPubYear << setw(30) << sCategory << setw(34) << nsl << endl;
	SET_COLOR(4);
	cout << "________________________________________________________________________________________________________________________________________________________________" << endl;
}
//nhap danh sach sach
...
void thuvien::adddanhsach(){
	...
	for(int i=0;i<this->n;i++){
        ...
        do
		{
        	...
        	for(int i = 0; i < this->n; i++)
        	{
        		if(tv->getsid = tv->getid(i))	cout << "id bi trung, moi nhap lai" << endl;
			}
		}
		while(tv->getid() = tv->getid(i));
        //tv->add();
		B.push_back(tv);
		Sleep(600);
        SET_COLOR(4);
...
int thuvien::SapXep(){
	...
	cout  << setw( 80 ) << "( S ) Sap Xep Theo So Luong Sach Tang Dan" << endl << endl

          << setw( 80 ) << "( I ) Sap Xep Theo So Luong Sach Giam Dan" << endl << endl

          << setw( 66 ) << "( N ) Sap Xep Theo Ten A->Z" << endl << endl

          << setw( 79 ) << "( T ) Sap Xep Theo Nam Xuat Ban Tang Dan" << endl << endl

          << setw( 79 ) << "( A ) Sap Xep Theo Nam Xuat Ban Giam Dan" << endl << endl

          << setw( 74 ) << "( X ) Sap Xep Theo Ten Tac Gia A->Z" << endl << endl

		  << setw( 66 ) << "( C ) Sap Xep Theo The Loai" << endl << endl

		  << setw( 70 ) << "( Q ) Tro Ve Chuong Trinh Chinh" << endl << endl;
...
int thuvien::Sua(){
	...
	cout  << setw( 54 ) << "( S ) Sua 1 Cuon" << endl << endl

          << setw( 55 ) << "( I ) Sua Toan Bo" << endl << endl

          << setw( 69 ) << "( Q ) Tro Ve Chuong Trinh Chinh" << endl << endl;
		  SET_COLOR(4);
	cout  << setw( 60 ) << "Nhap lua chon cua ban      [ ]" << endl << endl;
			gotoxy(58,10);
...
int thuvien::xoasach(){
	...
	cout  << setw( 66 ) << "( S ) Xoa Theo Ten Sach" << endl << endl

          << setw( 60 ) << "( I ) Xoa Theo ID" << endl << endl

          << setw( 70 ) << "( N ) Xoa Theo Nam Xuat Ban" << endl << endl

          << setw( 66 ) << "( T ) Xoa Theo The Loai" << endl << endl

          << setw( 69 ) << "( A ) Xoa Theo Ten Tac Gia" << endl << endl

          << setw( 74 ) << "( Q ) Tro Ve Chuong Trinh Chinh" << endl << endl;
		  SET_COLOR(4);
	cout  << setw( 60 ) << "Nhap lua chon cua ban      [ ]" << endl << endl;
			gotoxy(58,16);
