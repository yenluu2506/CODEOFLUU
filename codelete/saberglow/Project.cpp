...
public:
    ...
    void TOTAL_SUBMITTED_FEEDBACKS()
    {
        ...
        cout << "\n               >> Tổng số tệp phản hồi đã gửi: " << TOTAL_FILES<<" <<"<<endl<<endl<<endl;
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    virtual bool PRINT_SUBMITTED_FEEDBACK_FORM()
    {
        ...
        if (!CHECK_EXISTING_FILE(FILE_PATH.c_str()))
        {
            cout << "\n\n\n";
            cout << "          __________________________________________________\n";
            cout << "         |  Chưa có phản hồi nào được gửi bởi sinh viên này ...    \n";
            cout << "         |__________________________________________________\n";
            return FALSE;
        }
        else
